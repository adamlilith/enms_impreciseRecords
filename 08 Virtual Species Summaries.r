...
### make composite plot with SUBSET of EOO and niche breadth results - TWO errorless scenarios ###
### make composite plot with SUBSET of ENM results - TWO errorless scenarios ###
...
#############
	...
	enmCalibPresentCaption <- paste0('Figure A2 Calibration accuracy of ENMs against the true present-day probability of occurrence. Violin plots, and gray and green points represent the correlation between predictions from ENMs calibrated using errorless and precise records (respectively) with the true probability of presence in the present. Green points represent the correlation between predictions from models calibrated using precise plus imprecise records and the true probability of presence. The thick black trend line traces the median trend and thin black lines bound the inner 90% of values. Higher values connote better calibration accuracy of ENMs.')
	
	enmCalibFutureCaption <- paste0('Figure A3 Calibration accuracy of ENMs against the true future-day probability of occurrence. Violin plots, and gray and green points represent the correlation between predictions from ENMs calibrated using errorless and precise records (respectively) with the true probability of presence in the future. Green points represent the correlation between predictions from models calibrated using precise plus imprecise records and the true probability of presence. The thick black trend line traces the median trend and thin black lines bound the inner 90% of values. Higher values connote better calibration accuracy of ENMs.')

	lostCaption <- paste0('Figure A4 Climatically suitable area estimated using ecological niche models that is lost due to climate change. Violin plots and green points depict the ratio of lost suitable area estimated using only precise records to suitable area estimated using errorless records.  Orange points represent the ratio of lost suitable area estimated using precise plus imprecise records to lost suitable area estimated using errorless records. The thick black trend line traces the median trend and thin black lines bound the inner 90% of values. Ratios were calculated as (estimated value + 1) / (errorless value + 1). To aid visualization, only the inner ', (1 - 2 * (1 - outlierQuant)) * 100, '% of values across all scenarios are shown.')

	gainCaption <- paste0('Figure A5 Climatically suitable area estimated using ecological niche models that is gained due to climate change. Violin plots and green points depict the ratio of gain in suitable area estimated using only precise records to gain in suitable area estimated using errorless records.  Orange points represent the ratio of gained suitable area estimated using precise plus imprecise records to gained suitable area estimated using errorless records. The thick black trend line traces the median trend and thin black lines bound the inner 90% of values. Ratios were calculated as (estimated value + 1) / (errorless value + 1). To aid visualization, only the inner ', (1 - 2 * (1 - outlierQuant)) * 100, '% of values across all scenarios are shown.')
	
	stableCaption <- paste0('Figure A6 Climatically suitable area estimated using ecological niche models that remains suitable in time. Violin plots and green points depict the ratio of stable suitable area estimated using only precise records to suitable area estimated using errorless records.  Orange points represent the ratio of stable suitable area estimated using precise plus imprecise records to stable suitable area estimated using errorless records. The thick black trend line traces the median trend and thin black lines bound the inner 90% of values. Ratios were calculated as (estimated value + 1) / (errorless value + 1). To aid visualization, only the inner ', (1 - 2 * (1 - outlierQuant)) * 100, '% of values across all scenarios are shown.')

	sqSuitCaption <- paste0('Figure A7 Present-day climatically suitable area estimated using ecological niche models. Violin plots and green points depict the ratio of present-day suitable area estimated using only precise records to suitable area estimated using errorless records.  Orange points represent the ratio of present-day suitable area estimated using precise plus imprecise records to suitable area estimated using errorless records. The thick black trend line traces the median trend and thin black lines bound the inner 90% of values. To aid visualization, only the inner ', (1 - 2 * (1 - outlierQuant)) * 100, '% of values across all scenarios are shown.')

	futSuitCaption <- paste0('Figure A8 Future climatically suitable area estimated using ecological niche models. Violin plots and green points depict the ratio of future suitable area estimated using only precise records to suitable area estimated using errorless records.  Orange points represent the ratio of future suitable area estimated using precise plus imprecise records to suitable area estimated using errorless records. The thick black trend line traces the median trend and thin black lines bound the inner 90% of values. Ratios were calculated as (estimated value + 1) / (errorless value + 1). To aid visualization, only the inner ', (1 - 2 * (1 - outlierQuant)) * 100, '% of values across all scenarios are shown.')

	eooCaption <- 'Figure A9 Estimates of extent of occurrence (EOO) compared to true EOO. The violin plot and green points depict the ratio of EOO estimated using only precise records to the true EOO obtained from errorless records. The violin plot covers the inner 90% of estimates, and the median is represented by the horizontal bar within it. Orange points represent the ratio of EOO estimated using precise plus imprecise records to true EOO. The thick black trend line traces the median trend and thin black lines bound the inner 90% of values.'

	matCaption <- paste0('Figure A10 Estimates of realized niche breadth in mean annual temperature (MAT). In each panel the violin plot and green points show the ratio of realized niche breadth in MAT estimated using only precise records to the true realized niche breadth obtained from errorless records. The violin plot encompasses the inner 90% of values and the horizontal line within represents the median value. The points and ratio of niche breadth estimated using precise plus imprecise records to true niche breadth (points). The thick black trend line traces the median trend and thin black lines bound the inner 90% of values. To assist in visualization, the top ', 100 * (1 - outlierQuant), '% of values across all scenarios are not shown.')

	tapCaption <- paste0('Figure A11 Estimates of realized niche breadth in total annual precipitation (TAP). In each panel the violin plot and green points show the ratio of realized niche breadth in TAP estimated using only precise records to the true realized niche breadth obtained from errorless records. The violin plot encompasses the inner 90% of values and the horizontal line within represents the median value. The points and ratio of niche breadth estimated using precise plus imprecise records to true niche breadth (points). The thick black trend line traces the median trend and thin black lines bound the inner 90% of values. To assist in visualization, the top ', 100 * (1 - outlierQuant), '% of values across all scenarios are not shown.')

	volCaption <- paste0('Figure A12 Estimates of realized multivariate niche breadth volume. The violin plot and green points show the ratio of realized niche volume estimated using only precise records to the true realized niche volume obtained from errorless records. The violin plot encompasses the inner 90% of values and the horizontal line within represents the median value. The orange points represent the ratio of niche volume estimated using precise plus imprecise records to true niche breadth. The thick black trend line traces the median trend and thin black lines bound the inner 90% of values. To assist in visualization, the top ', 100 * (1 - outlierQuant), '% of values across all scenarios are not shown.')

	areaCaption <- paste0('Figure A13 Estimates of realized multivariate niche surface area. The violin plot and green points show the ratio of realized niche area estimated using only precise records to the true realized niche area obtained from errorless records. The violin plot encompasses the inner 90% of values and the horizontal line within represents the median value. The orange points represent the ratio of niche area estimated using precise plus imprecise records to true niche breadth. The thick black trend line traces the median trend and thin black lines bound the inner 90% of values. To assist in visualization, the top ', 100 * (1 - outlierQuant), '% of values across all scenarios are not shown.')
...
say('################################################################################')
	...
	############################
		...
		for (thisNumErrorless in numErrorlessSelected) {
			...
			for (thisNumPrecise in allowableNumPreciseSelected) {
				...
				boxPanel <- ggplot(errorlessPreciseDf, aes(x=x, y=resp)) +
					...
					scale_x_continuous(breaks=c(-0.5, 0.5), labels=c('Error.', 'Prec.')) +
					scale_y_continuous(breaks=ybreaks) +
		...
		calibSq <- (panels[[1]] + panels[[2]]) / (panels[[3]] + panels[[4]]) +
			plot_layout(nrow=2) +
			plot_annotation(
				title = title,
				theme=theme(
	...
	############################
		...
		calibFut <- (panels[[1]] + panels[[2]]) / (panels[[3]] + panels[[4]]) +
			plot_layout(nrow=2) +
			plot_annotation(
				title = title,
				theme=theme(
	...
	##########################
		...
		ylab <- 'Estimated / errorless suitable area'
		...
		for (thisNumErrorless in numErrorlessSelected) {
			...
			for (thisNumPrecise in allowableNumPreciseSelected) {
				...
				if (length(panels) == 2) comboPanel <- comboPanel +
					geom_text(aes(x=0, y=1, label='Estimated / errorless suitable area', angle=90, size=axisSizeY, vjust=0))
		...
		sqSuit <- (panels[[1]] + panels[[2]]) / (panels[[3]] + panels[[4]]) +
			plot_layout(nrow=2) +
			plot_annotation(
				title = title,
				theme=theme(
	...
	##########################
		...
		futSuit <- (panels[[1]] + panels[[2]]) / (panels[[3]] + panels[[4]]) +
			plot_layout(nrow=2) +
			plot_annotation(
				title = title,
				theme=theme(
	...
	#######################
		...
		for (thisNumErrorless in numErrorlessSelected) {
			...
			for (thisNumPrecise in allowableNumPreciseSelected) {
				...
				comboPanel <- plot_grid(boxPanel, imprecisePanel, ncol=2, rel_widths=c(0.55, 1), align='h')
				if (length(panels) == 2) comboPanel <- comboPanel +
					geom_text(aes(x=0, y=1, label='Estimated / errorless area loss', angle=90, size=axisSizeY, vjust=0))
		...
		loss <- (panels[[1]] + panels[[2]]) / (panels[[3]] + panels[[4]]) +
			plot_layout(nrow=2) +
			plot_annotation(
				title = title,
				theme=theme(
	...
	#######################
		...
		ylab <- 'Estimated / errorless suitable area gain'
		...
		for (thisNumErrorless in numErrorlessSelected) {
			...
			for (thisNumPrecise in allowableNumPreciseSelected) {
				...
				comboPanel <- plot_grid(boxPanel, imprecisePanel, ncol=2, rel_widths=c(0.55, 1), align='h')
				if (length(panels) == 2) comboPanel <- comboPanel +
					geom_text(aes(x=0, y=1, label='Estimated / errorless area gain', angle=90, size=axisSizeY, vjust=0))
		...
		gain <- (panels[[1]] + panels[[2]]) / (panels[[3]] + panels[[4]]) +
			plot_layout(nrow=2) +
			plot_annotation(
				title = title,
				theme=theme(
	...
	###########
		...
		ggsave(plot=main, filename=paste0('./Analysis/Virtual Species/!Selected ENM Results ', paste(numErrorlessSelected, collapse=' '), ' Errorless & ', paste(numPreciseSelected, collapse=' '), ' Precise.pdf'), width=8.5, height=11, units='in')
...
say('##################################################################')
	...
	##############################
		...
		plotFileName <- '!Climate Change Exposure - Present-Day Suitable Area - All Results'
		trendsFileName <- '!Trends - Climate Change Exposure - Present-Day Suitable Area'
		...
		for (thisNumErrorless in numErrorlessSelected) {
			...
			for (thisNumPrecise in allowableNumPreciseSelected) {
				...
				main <- paste0(letter, ') ', thisNumErrorless, ' errorless\n& ', thisNumPrecise, ' precise')
