...
### 
### source('C:/Ecology/Drive/Research/Vaguely Georeferenced Specimen Records/Code/03 Calculate Climate Change Exposure Using ENMs.r')
### source('E:/Ecology/Drive/Research/Vaguely Georeferenced Specimen Records/Code/03 Calculate Climate Change Exposure Using ENMs.r')
