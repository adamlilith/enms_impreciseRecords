...
### 
### source('C:/Ecology/Drive/Research Active/Vaguely Georeferenced Specimen Records/Code/07 Virtual Species - Completely Synthetic.r')
### source('E:/Ecology/Drive/Research Active/Vaguely Georeferenced Specimen Records/Code/07 Virtual Species - Completely Synthetic.r')
