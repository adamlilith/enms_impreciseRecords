...
### 
### source('C:/Ecology/Drive/Research Active/Vaguely Georeferenced Specimen Records/Code/09 Example of Virtual Species Simulations.r')
### source('E:/Ecology/Drive/Research Active/Vaguely Georeferenced Specimen Records/Code/09 Example of Virtual Species Simulations.r')
