...
#############
	...
	enmCalibPresentCaption <- paste0('Figure S2 Calibration accuracy of ENMs against the true present-day probability of occurrence. Violin plots, and gray and green points represent the correlation between predictions from ENMs calibrated using errorless and precise records (respectively) with the true probability of presence in the present. Green points represent the correlation between predictions from models calibrated using precise plus imprecise records and the true probability of presence. The thick black trend line traces the median trend and thin black lines bound the inner 90% of values. Higher values connote better calibration accuracy of ENMs.')
	
	enmCalibFutureCaption <- paste0('Figure S3 Calibration accuracy of ENMs against the true future-day probability of occurrence. Violin plots, and gray and green points represent the correlation between predictions from ENMs calibrated using errorless and precise records (respectively) with the true probability of presence in the future. Green points represent the correlation between predictions from models calibrated using precise plus imprecise records and the true probability of presence. The thick black trend line traces the median trend and thin black lines bound the inner 90% of values. Higher values connote better calibration accuracy of ENMs.')
